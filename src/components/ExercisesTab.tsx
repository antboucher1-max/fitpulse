...
export default function ExercisesTab({ exercises, exerciseSearch, setExerciseSearch, selectedCategoryFilter, setSelectedCategoryFilter, onSelectExercise }: ExercisesTabProps) {
  return (
      ...
      <div className="bg-neutral-900 border border-neutral-800 rounded-3xl p-5 space-y-4">
        ...
        <div className="space-y-3 pt-1">
          {exercises
            ...
            .map((ex) => (
              <div key={ex.id} onClick={() => onSelectExercise(ex)} className="bg-neutral-950 p-4 rounded-2xl border border-neutral-800 hover:border-orange-500/50 cursor-pointer flex items-center justify-between transition">
