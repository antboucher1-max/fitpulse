...
export default function SncShieldWidget({ 
  ...
  const getBadgeStyle = () => {
    switch (shieldData.riskLevel) {
      case 'critical': return 'bg-red-950/30 border-red-500/40 text-red-400';
      case 'warning': return 'bg-amber-950/30 border-amber-500/40 text-amber-400';
      default: return 'bg-neutral-900/90 border-neutral-800/80 text-emerald-400';
    }
  };

  return (
    <div className={`border rounded-3xl p-5 space-y-3.5 shadow-xl transition-all ${getBadgeStyle()}`}>
      ...
      <div className="bg-neutral-950 border border-neutral-800/80 p-3 rounded-2xl space-y-1">
        <div className="flex items-center justify-between text-[11px]">
          ...
          <span className="text-[10px] text-neutral-500 font-mono">IA</span>
        </div>
