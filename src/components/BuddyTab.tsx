...
import { Users, UserPlus, Check, Clock, MapPin, Search, ShieldCheck, UserMinus, Sparkles, Filter, SlidersHorizontal, X } from 'lucide-react';
...
// Fonction de calcul de match affinée avec les critères demandés
const calculateMatchScore = (currentUser: RealUser | undefined, targetUser: RealUser, filters: { onlyWomen: boolean; ageCategory: string; timeSlot: string; club: string }) => {
  ...
  // Critère Tranche horaire / Disponibilité : +15%
...
export default function BuddyTab({
  ...
  // Filtres avancés du système de match
  ...
  // Recherche et calcul du matching multicritères
  const searchResults = registeredUsers
    ...
    .filter(u => u.matchScore !== -1) // Retirer ceux exclus par les filtres stricts (ex: entre femmes)
        ...
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-neutral-900 border border-neutral-800 rounded-3xl max-w-md w-full p-6 space-y-5 shadow-2xl animate-fadeIn">
            ...
            <div className="space-y-4">
              {/* Option Entre femmes uniquement */}
