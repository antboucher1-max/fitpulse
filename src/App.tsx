...
// Composant nettoyé et guidé pour la Forme & Readiness (0 données fictives au départ)
function CleanReadinessTab({ currentUserId, onBack }: { currentUserId?: string; onBack?: () => void }) {
