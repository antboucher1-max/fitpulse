...
export default function App() {
  ...
  const handleSyncProfile = async (sessionUser: SupabaseUser) => {
    try {
  ...
  useEffect(() => {
    ...
    const presenceInterval = setInterval(() => {
      if (user) handleSyncProfile(user);
    }, 30000);
        ...
        {currentTab === 'fitbot' && (
          <div className="space-y-4">
            <div className="bg-neutral-900 border border-neutral-800 rounded-3xl overflow-hidden flex flex-col h-[74vh]">
              <div className="p-4 bg-neutral-950 border-b border-neutral-800 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-[10px] text-green-500 font-semibold">● En ligne 24/7</span>
                  </div>
                </div>
              </div>
              ...
              <form onSubmit={handleSendAIChat} className="p-3.5 bg-neutral-950 border-t border-neutral-800 flex items-center gap-2.5">
                <input 
                  type="text" 
                  placeholder="Demande un programme Basic-Fit, nutrition..." 
                  value={aiInputText} 
